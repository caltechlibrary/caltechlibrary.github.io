...
(function (document) {
    ...
    function closeNav(ev) {
        console.log("DEBUG closeNav();");
        removeClassName('cl-nav-ul-display-inline-block');
    }
    ...
    for (i = 0; i < navAnchors.length; i += 1) {
        navAnchors[i].addEventListener('focus', openNav, false);
        navAnchors[i].addEventListener('blur', closeNav, false);
    }
